                    ...
                    <>
                        ...
                        <div className="profile-info">
                            ...
                            <div className="profile-details">
                                ...
                                <p>Role: {user.role}</p>
                                {user.role === 'teacher' && (
                                    <button id='create_cls_button' className="create-classroom-btn" onClick={() => setShowPopup(true)}>
                                        Create Classroom
                                    </button>
                                )}
                            </div>
                            ...
                            <div className="popup-overlay">
                                <div className="popup-content">
                                    ...
                                    <div className="popup-buttons">
                                        <button id='create_cls_submit' onClick={handleCreateClassroom}>Submit</button>
